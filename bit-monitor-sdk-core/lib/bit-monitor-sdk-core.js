(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.bitMonitorSdkCore = factory());
  ...
  var DEFAULT_CONFIG = {
    ...
    isAutoUpload: true // If true, BitMonitorSdkCore will automatically call callback function
  ...
  var BufferPool = /*#__PURE__*/function () {
    function BufferPool(capacity) {
      ...
      if (typeof capacity !== 'number') {
        throw new Error('[error]BitMonitorSdkCore->BufferPool: capacity is not legal!');
      }

      if (capacity < 1) {
        throw new Error('[error]BitMonitorSdkCore->BufferPool: capacity should not less than 0!');
      }
  ...
  var BitMonitorSdkCore = /*#__PURE__*/function () {
    function BitMonitorSdkCore() {
      _classCallCheck(this, BitMonitorSdkCore);
    ...
    _createClass(BitMonitorSdkCore, [{
      key: "init",
